...
public final class ImageGrpc {
  ...
  private static final class ImageDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    @java.lang.Override
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return net.intellij.plugins.livesexyeditor.grpc.ImageProto.getDescriptor();
    }
  }
      ...
      synchronized (ImageGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new ImageDescriptorSupplier())
